    ...
    public void sendMessageToAllEntities(Message message) {
        if (message.getMessageType().equals(Message.MESSAGE_TYPE.DISPLAY_BUY_MENU)) {
            ...
            if (entity != null) {
                ...
                MainGameScreen.getInstance().sendMessageToAllEntities(new AddScorePerSecondMessage(buyingObjectDisplayEntity.getCostBonusPerSecond()));
            }
